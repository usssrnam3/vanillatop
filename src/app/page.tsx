    ...
    <main className="relative flex min-h-screen flex-col items-center overflow-hidden px-4 py-8">
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <div className="mt-8 w-full max-w-4xl space-y-3">
          <details className="group rounded-2xl border border-neutral-800 bg-black/60 p-5 shadow-xl backdrop-blur-md">
            <summary className="flex cursor-pointer items-center justify-between text-lg font-bold text-white">
              Реквизиты
              <span className="text-sm text-neutral-500 transition group-open:rotate-180">▼</span>
            </summary>
          ...
          <details className="group rounded-2xl border border-neutral-800 bg-black/60 p-5 shadow-xl backdrop-blur-md">
            ...
            <div className="mt-3 space-y-2 text-sm text-neutral-400">
              <p>Возврат средств возможен только <strong className="text-white">до активации</strong> услуги на сервере.</p>
              <p>После активации услуги (выдачи доступа к VPass) — возврат не производится, так как услуга оказана в полном объёме.</p>
              <p>Для возврата до активации — обратитесь по e-mail, указанному в реквизитах.</p>
            </div>
          </details>
        </div>
